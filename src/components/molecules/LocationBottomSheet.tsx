...
>(({requestLocationPermission = () => {}, locationPermission}, ref) => {
          ...
          {pincodeDetailsShown ? (
            <>
              ...
              <View
                ...
                <TouchableOpacity
                  disabled={
                    pincode?.length == 6 || pincode?.length == 4 ? false : true
                  }
                  activeOpacity={0.6}>
                  <Text
                    style={
            ...
            <>
              ...
              <View style={styles.buttonContainer}>
                ...
                <Button
                  ...
                  buttonStyle={{
                    ...styles.filledButton,
                    opacity: locationPermission === 'never_ask_again' ? 0.6 : 1,
                  }}
                  activeOpacity={0.6}
                  disabled={
                    locationPermission === 'never_ask_again' ? true : false
                  }
                />
              </View>
            </>
