...
const LoginBottomSheet = forwardRef<LoginBottomSheetRef, LoginBottomSheetProps>(({ onPressContinue = () => { } }, ref) => {
    ...
    return (
        <BottomSheetModalProvider>
            <BottomSheetModal
                ...
                handleIndicatorStyle={{ backgroundColor: '#E0E0E0', width: Matrics.s(45), height: Matrics.vs(4) }}
                index={0}
                snapPoints={['75%']}
