...
const HomeScreen: React.FC<HomeScreenProps> = ({route, navigation}) => {
  ...
  const crypto = () => {
    ...
    var ciphertext = CRYPTO.AES.encrypt(
      JSON.stringify({otp: '1234', contact_no: '8511449158'}),
      key,
      {
        iv: iv,
    ...
    var decryptedData = CRYPTO.AES.decrypt(
      'mHseU7meqOo7S3aq/vgQmOpvmwrgUWFI0z63FEvwffP6imwite97eSgma2ah/ZAECejeQddtlWqzKep3MaGH5A==',
      key,
      {
        iv: iv,
        mode: CRYPTO.mode.CBC,
