...
const SelectTestSlotScreen: React.FC<SelectTestSlotScreenProps> = ({
  route,
  navigation,
}) => {
  ...
  const renderSlots = (
    ...
    return (
      <SlotButton
        ...
        titleStyle={
          selectedTime.id === id && selectedTime.timeZone === timeZone
            ? styles.activeTimeTxt
            : styles.inactiveTimeTxt
        }
      />
    );
  };
        ...
        <View
          ...
          <View style={styles.slotWraper}>
            {item.slots.map((slot, index) =>
              renderSlots(item.timeZone, item.id, slot, index),
            )}
          </View>
        </View>
      </View>
