...
import {DiagnosticStackParamList} from '../../interface/Navigation.interface';
...
const AddPatientDetailsScreen: React.FC<AddPatientDetailsScreenProps> = ({
  route,
  navigation,
}) => {
    ...
    <ScrollView style={{flex: 1, backgroundColor: '#F9F9FF', padding: 15}}>
      ...
      <View style={{marginVertical: 8}}>
        ...
        <Text style={styles.messageText}>
          Select the relation with name of the account{' '}
        </Text>
      </View>
      <View style={{marginVertical: 8}}>
        <AnimatedInputField
      ...
      <View style={{marginVertical: 8}}>
        ...
        />
        <Text style={styles.messageText}>
          User will receive updates of order status and soft copy of reports on
          this email address{' '}
        </Text>
      </View>
      <View style={{marginVertical: 8}}>
