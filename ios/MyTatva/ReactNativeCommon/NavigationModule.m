...
RCT_EXTERN_METHOD(navigateToIncident: (NSArray)destination)
RCT_EXTERN_METHOD(navigateToDiscover)
RCT_EXTERN_METHOD(showTabbar)
RCT_EXTERN_METHOD(hideTabbar)
RCT_EXTERN_METHOD(navigateToChronicCareProgram: (NSString)destination)
RCT_EXTERN_METHOD(goBackFromChat)
RCT_EXTERN_METHOD(navigateToExercise: (NSArray)destination)
RCT_EXTERN_METHOD(openPlanDetails: (NSArray)destination)
RCT_EXTERN_METHOD(onPressRenewPlan: (NSArray)destination)
RCT_EXTERN_METHOD(navigateToBookAppointment: (NSString)destination)
RCT_EXTERN_METHOD(openHealthKitSyncView)
RCT_EXTERN_METHOD(openAddWeightHeight)
