//
//  GeoLocationPopupVM.swift
//  MyTatva
//
//  Created by 2022M43 on 05/09/23.
//

import Foundation
class GeoLocationPopupVM {
    //MARK: Outlet
...
extension GeoLocationPopupVM {
    ...
    func apiCall(vc: UIViewController,
                 ...
                 street: UITextField,
                 addressType: String,
                 isEdit: Bool, latitude: String = "",longitude: String = "") {
