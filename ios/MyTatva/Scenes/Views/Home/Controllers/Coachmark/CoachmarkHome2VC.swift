...
class CoachmarkHome2VC: ClearNavigationFontBlackBaseVC {
    ...
    private func setUpView() {
        ...
        self.lblTitle.text = CoachmarkListModel.shared.description(page: .home_goal)
...
//            var getY = self.vwBgParent.frame.origin.y - (self.targetView.frame.origin.y + self.targetView.frame.height)
//            if self.vwBgParent.frame.origin.y > self.targetView.frame.height {
//                //Move up Y
//                getY = (self.vwBgParent.frame.origin.y - (self.targetView.frame.origin.y + self.targetView.frame.height))
//            }
//            else {
//                //Move down Y
//                getY = self.vwBgParent.frame.origin.y + (self.targetView.frame.height - self.vwBgParent.frame.origin.y)
//            }
...
//            self.showcase.setTargetView(view: self.targetView)
