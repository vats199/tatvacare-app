...
class CoachmarkCarePlan2VC: ClearNavigationFontBlackBaseVC {
    ...
    private func setUpView() {
        ...
        self.lblTitle.text = CoachmarkListModel.shared.description(page: .care_plan_goal)
...
//            self.showcase.targetHolderRadius = self.targetView.frame.width
...
//            self.vwBgParent.transform = CGAffineTransform(translationX: 0, y: getY)
            ...
            let color = GFunction.shared.applyGradientColor(startColor: UIColor.themeBlack.withAlphaComponent(0),
                                                            ...
                                                            locations: [0, 0.1],
                                                            startPoint: CGPoint(x: 0, y: self.imgBg.frame.maxY - self.targetView.frame.height),
