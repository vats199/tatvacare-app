...
class CoachmarkCarePlanToEngageVC: ClearNavigationFontBlackBaseVC {
    ...
    private func setUpView() {
        ...
        self.lblTitle.text = CoachmarkListModel.shared.description(page: .care_plan_engage)
        ...
        DispatchQueue.main.async {
            ...
            self.showcase.setTargetView(tabBar: self.targetTabbar, itemIndex: 1, tapThrough: false)
