...
class FoodQuantityCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        ...
        self.lblQuantity.font(name: .regular, size: 13).textColor(color: UIColor.themeBlack)
...
class FoodQuantityHelpVC: ClearNavigationFontBlackBaseVC{
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.viewModel.apiCallFromStart(colView: self.colView, refreshControl: self.refreshControl, withLoader: true)
...
extension FoodQuantityHelpVC : UICollectionViewDataSource, UICollectionViewDelegate,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.lblTitle.text = object.utensilName
        cell.lblQuantity.text = object.quantity
        cell.imgQuantity.setCustomImage(with: object.imageUrl)
        
        DispatchQueue.main.async {
            cell.imgQuantity.transform = CGAffineTransform(scaleX: 0.4, y: 0.4)
            UIView.animate(withDuration: kAnimationSpeed) {
                cell.imgQuantity.transform = .identity
            }
        }
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        //let height = 20 * ScreenSize.widthAspectRatio
