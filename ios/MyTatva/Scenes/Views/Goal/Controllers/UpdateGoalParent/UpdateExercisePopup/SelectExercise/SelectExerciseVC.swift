...
class SelectExerciseVC: WhiteNavigationBaseVC {
    ...
    let viewModel                   = SelectExerciseVM()
    let refreshControl              = UIRefreshControl()
    var strErrorMessage : String    = ""
    
    var completionHandler: ((_ obj : ExerciseListModel?) -> Void)?
...
//----------------------------------------------------------------------------
extension SelectExerciseVC : UITableViewDataSource, UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.lblTitle.text = object.exerciseName
...
extension SelectExerciseVC : DZNEmptyDataSetDelegate, DZNEmptyDataSetSource {
...
extension SelectExerciseVC: UITextFieldDelegate {
