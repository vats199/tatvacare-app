...
class SetupProfileVC2: UIViewController {
    //MARK: - Outlets -
    ...
    var inputs: [UITextField] {
        get {
            return [txtName, txtEmail, txtDOB]
        }
    }
    ...
    required init?(coder: NSCoder) {
        ...
        self.viewModel = SetupProfileVM2()
    }
    ...
    func applyStyle() {
        ...
        self.lblGender.font(name: .bold, size: 14).textColor(color: .themeBlack2)
        ...
        self.lblDoctorCode.attributedText = self.lblDoctorCode.text!.getAttributedText(defaultDic: defaultDicQue, attributeDic: defaultDicQue1, attributedStrings: ["(Optional)"])
...
extension SetupProfileVC2 : UITextFieldDelegate {
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        case self.txtEnterCode:
            ...
            self.pendingRequest = DispatchWorkItem(block: { [weak self] in
                guard let self = self else { return }
//                self.btnCheck.isHidden = self.txtEnterCode.isEmpty
