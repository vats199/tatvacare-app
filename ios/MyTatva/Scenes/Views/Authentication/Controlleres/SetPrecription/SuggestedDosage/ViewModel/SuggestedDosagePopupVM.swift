...
//MARK: ---------------- Update Data ----------------------
extension SuggestedDosagePopupVM {
    
    func getCount() -> Int {
        return self.arrList.count
    }
    
    func getObject(index: Int) -> DoseListModel {
    ...
    func manageSelection(index: Int) {
        ...
        for item in self.arrList {
            ...
            if item.doseMasterId == object.doseMasterId {
                item.isSelected = true
            }
        }
    }
    
    func getSelectedObject() ->  DoseListModel? {
            ...
            if index == self.arrList.count - 1 {
                if self.isNextPage {
                    ...
                    if self.arrList.count > 0 {
                        ...
                        self.doseListAPI(tblView: tblView,
...
extension SuggestedDosagePopupVM {
    ...
    func doseListAPI(tblView: UITableView? = nil,
                        withLoader: Bool,
        ...
        ApiManager.shared.makeRequest(method: ApiEndPoints.patient(.dose_list), methodType: .post, parameter: params, withErrorAlert: true, withLoader: withLoader, withdebugLog: true) { (result) in
            ...
            case .success(let response):
                ...
                case .success:
                    ...
                    returnVal = true
                    arr = DoseListModel.modelsFromDictionaryArray(array: response.data.arrayValue)
