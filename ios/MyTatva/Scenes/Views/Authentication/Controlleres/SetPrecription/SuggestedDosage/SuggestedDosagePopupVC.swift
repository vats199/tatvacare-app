...
class SuggestedDosagePopupVC: ClearNavigationFontBlackBaseVC {
...
extension SuggestedDosagePopupVC {
...
//MARK:- UITableView Methods
//----------------------------------------------------------------------------
extension SuggestedDosagePopupVC : UITableViewDataSource, UITableViewDelegate{
...
extension SuggestedDosagePopupVC : DZNEmptyDataSetDelegate, DZNEmptyDataSetSource {
