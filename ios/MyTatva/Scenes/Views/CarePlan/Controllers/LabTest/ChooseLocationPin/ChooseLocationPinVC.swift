...
class ChooseLocationPinVC: ClearNavigationFontBlackBaseVC {
    ...
    @IBOutlet weak var btnSelectLoc     : UIButton!
    @IBOutlet weak var btnSubmit        : UIButton!
    @IBOutlet weak var btnCancel        : UIButton!
    
    
    //MARK:- Class Variable
    let viewModel                       = ChooseLocationPinVM()
    ...
    fileprivate func manageActionMethods(){
        ...
        self.btnSelectLoc.addTapGestureRecognizer {
            ...
            if LocationManager.shared.checkStatus() == .authorizedAlways || LocationManager.shared.checkStatus() == .authorizedWhenInUse {
                ...
                GoogleNavigationAdddress.getAddressFromLatLong(lat: lat, lng: long) { (response) in
                    ...
                    if response[StringConstant.PinCode].stringValue != "" {
                        ...
                        self.strPincode   = response[StringConstant.PinCode].stringValue
                        self.txtCode.text = self.strPincode
                    }
                    else {
