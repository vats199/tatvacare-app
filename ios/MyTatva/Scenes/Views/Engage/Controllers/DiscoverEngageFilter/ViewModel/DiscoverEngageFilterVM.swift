...
//MARK: ---------------- Update Data ----------------------
extension DiscoverEngageFilterVM {
...
//        })
        ...
        ApiManager.shared.makeRequest(method: ApiEndPoints.content(.content_filters), methodType: .post, parameter: params, withErrorAlert: true, withLoader: withLoader, withdebugLog: true) { (result) in
