...
class AskExpertFilterVC: ClearNavigationFontBlackBaseVC {
    ...
    //MARK:- Class Variable
    let viewModel                       = AskExpertFilterVM()
...
//            }
            ...
            objTemp.questionType    = [FilterQuestionType]()
            ...
            if self.object.language != nil {
                ...
                for item in self.object.questionType {
                    if item.isSelected {
                        objTemp.questionType.append(item)
                    }
                }
            }
        ...
        self.btnReset.addTapGestureRecognizer {
            ...
            if self.object.questionType != nil {
                for item in self.object.questionType {
                    item.isSelected = false
                }
            }
...
extension AskExpertFilterVC {
    ...
    fileprivate func setData(){
        ...
        //Check selected question type
        if self.offlineobject.questionType != nil {
            if self.offlineobject.questionType.count > 0 {
                for parent in self.offlineobject.questionType {
                    for child in self.object.questionType {
...
//MARK:- UITableView Methods
//----------------------------------------------------------------------------
extension AskExpertFilterVC : UITableViewDataSource, UITableViewDelegate{
...
//                break
            case 0:
                ...
                break
            case 1:
                cell.lblTitle.text  = "Question type"
                cell.type           = .question_type
                break
            default:break
            }
...
extension AskExpertFilterVC : DZNEmptyDataSetDelegate, DZNEmptyDataSetSource {
