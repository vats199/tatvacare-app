...
class GuideMessageView extends LinearLayout {
    ...
    GuideMessageView(Context context) {
        ...
        mPositiveButton.setBackgroundColor(Color.MAGENTA);
        mPositiveButton.setTextSize(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_CONTENT_TEXT_SIZE);
        mPositiveButton.setPadding(padding, paddingBottom, padding, padding);
        ...
        mNegativeTextView.setTextColor(Color.MAGENTA);
        mNegativeTextView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_CONTENT_TEXT_SIZE);
        mNegativeTextView.setPadding(padding, paddingBottom, padding, padding);
