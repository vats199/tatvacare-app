...
public class GuideView extends FrameLayout {
    ...
    // for custom guide view layout
    private final View mMessageView;
    private final AppCompatTextView textViewTitle;
    private final AppCompatButton buttonNext;
    private final AppCompatTextView textViewSkip;
    private final AppCompatImageView imageViewClose;
    ...
    private GuideView(Context context, View view) {
        ...
        mMessageView = LayoutInflater.from(getContext()).inflate(R.layout.dialog_layout_coachmark, null);

        textViewTitle = mMessageView.findViewById(R.id.textViewTitle);

        buttonNext = mMessageView.findViewById(R.id.buttonNext);
        buttonNext.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                dismiss();
                mGuideListener.onNext(target);
            }
        });

        textViewSkip = mMessageView.findViewById(R.id.textViewSkip);
        textViewSkip.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                dismiss();
                mGuideListener.onSkip();
            }
        });

        imageViewClose = mMessageView.findViewById(R.id.imageViewClose);
...
//        mMessageView.setContentTextSize(size);
    ...
    public static class Builder {
        ...
        private String title, contentText, buttonText, extraActionText;
         ...
         * defining a description for the target view
         *
         * @param buttonText a text to set in button. for example: this button can for submit your information..
         **/
         ...
         * defining a description for the target view
         *
         * @param extraActionText a another action text. for example: skip..
         **/
        public Builder setExtraActionText(String extraActionText) {
            this.extraActionText = extraActionText;
            return this;
        }
