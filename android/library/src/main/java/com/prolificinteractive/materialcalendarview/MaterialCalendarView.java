...
public class MaterialCalendarView extends ViewGroup {
  ...
  public MaterialCalendarView(Context context, AttributeSet attrs) {
    ...
    int calendarHeaderUi = 0; //default 0 (center_title)
    try {
      calendarHeaderUi = a.getInteger(
              R.styleable.MaterialCalendarView_mcv_calendarHeaderUi,
              0
      );
    } catch (Exception e) {
      e.printStackTrace();
    ...
    final View content = calendarHeaderUi==1
            ? inflater.inflate(R.layout.calendar_view_time_slot, null, false)
