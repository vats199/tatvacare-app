...
import com.mytatva.patient.databinding.CarePlanRowAppointmentBinding
import com.mytatva.patient.ui.manager.Navigator
import com.mytatva.patient.utils.imagepicker.loadCircle

class CarePlanAppointmentAdapter(
    var list: ArrayList<AppointmentData>,
    val navigator: Navigator,
    val adapterListener: AdapterListener,
) : RecyclerView.Adapter<CarePlanAppointmentAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = CarePlanRowAppointmentBinding.inflate(
    ...
    inner class ViewHolder(val binding: CarePlanRowAppointmentBinding) :
