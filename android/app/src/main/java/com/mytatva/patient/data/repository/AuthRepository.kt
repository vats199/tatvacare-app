...
interface AuthRepository {
    ...
    suspend fun addMedicinePrescription(apiRequest: ApiRequest): DataWrapper<Any>
    suspend fun fetchMedicinePrescription(apiRequest: ApiRequest): DataWrapper<ArrayList<MyPrescriptionMainData>>
