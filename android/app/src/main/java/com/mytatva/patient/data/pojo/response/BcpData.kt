...
class BcpPurchasedData(
    ...
    @SerializedName("is_test_added_in_cart")
    val is_test_added_in_cart: String? = null,
    @SerializedName("test_code")
    val test_code: String? = null,
    @SerializedName("vendor_flag")
    val vendor_flag: String? = null,
) {
    val isTestAddedInCart: Boolean
        get() = is_test_added_in_cart == "Y"
}
...
class BcpPlanData(
    ...
    var vendor_test_flag: String? = null,
...
class BcpDuration(
    ...
    val isAllFreeLabTestUsed: Boolean
        get() {
            return diagnostic_test_session_count == diagnostic_test_used_count
        }
    ...
    val androidFinalAmount: Int
        /*Double*/
        get() {
            return (android_final_amount?.toDoubleOrNull()?.roundToInt()
                ?: 0) - couponCodeDiscountAmount
        }
