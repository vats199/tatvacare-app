    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            if (isGoal) {
                ...
                imageViewIconReading.imageTintList = ColorStateList.valueOf(item.color_code.parseAsColor())
                imageViewIconReading.backgroundTintList= ColorStateList.valueOf(item.background_color.parseAsColor())
            }
        }
    }
                ...
                if (list[bindingAdapterPosition].mandatory != "Y") {
                    ...
                    if (isGoal) {
                        analytics.logEvent(analytics.USER_SELECT_GOAL, Bundle().apply {
                            putString(analytics.PARAM_GOAL_ID,
                                list[bindingAdapterPosition].goal_master_id)
                            putString(analytics.PARAM_GOAL_NAME,
                                list[bindingAdapterPosition].goal_name)
                            putString(analytics.PARAM_IS_SELECT,
