...
interface LatLngInterceptor {
    ...
    class Spherical : LatLngInterceptor {
        ...
        fun interpolate(fraction: Float, from: LatLng, to: LatLng): LatLng {
            ...
            val x = a * cosFromLat * kotlin.math.cos(fromLng) + b * cosToLat * kotlin.math.cos(toLng)
            val y = a * cosFromLat * kotlin.math.sin(fromLng) + b * cosToLat * kotlin.math.sin(toLng)
