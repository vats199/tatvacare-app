...
public class MyCandleStickChartRender extends CandleStickChartRenderer {
    ...
    public MyCandleStickChartRender(CandleDataProvider chart, ChartAnimator animator, ViewPortHandler viewPortHandler, int highLightColor) {
        ...
        for (int j = mXBounds.min; j <= mXBounds.range + mXBounds.min; j++) {
            ...
            if (showCandleBar) {
                ...
                if (open > close) { // decreasing
                    ...
                    if (mRadius > 0) {
                        c.drawRoundRect(new RectF(mBodyBuffers[0], mBodyBuffers[1],
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (Highlight high : indices) {
            ...
            float y = highValue;//(lowValue + highValue) / 2f;
