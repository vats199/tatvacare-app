...
import com.mytatva.patient.databinding.ExerciseRowMyPlansSubBinding
import com.mytatva.patient.utils.imagepicker.loadDrawable

class ExerciseMyPlansSubAdapter(
    val mainPosition: Int,
    var list: List<ExercisePlanSubData>,
    val adapterListener: AdapterListener,
    val isShowSelectIcon: Boolean,
) : RecyclerView.Adapter<ExerciseMyPlansSubAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ExerciseRowMyPlansSubBinding.inflate(
    ...
    inner class ViewHolder(val binding: ExerciseRowMyPlansSubBinding) :
