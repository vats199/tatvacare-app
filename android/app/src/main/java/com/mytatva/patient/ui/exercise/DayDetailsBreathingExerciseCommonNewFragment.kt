...
import com.mytatva.patient.databinding.ExerciseFragmentDayDetailsBreathingExerciseCommonNewBinding
...
import com.mytatva.patient.ui.exercise.adapter.DayDetailsBreathingExerciseNewAdapter
import com.mytatva.patient.ui.viewmodel.EngageContentViewModel
import com.mytatva.patient.utils.firebaseanalytics.AnalyticsScreenNames
import com.mytatva.patient.utils.firebaseanalytics.AnalyticsScreenNames.ExercisePlanDayDetail
import java.util.*
import java.util.concurrent.TimeUnit

class DayDetailsBreathingExerciseCommonNewFragment() :
    BaseFragment<ExerciseFragmentDayDetailsBreathingExerciseCommonNewBinding>() {
    ...
    private val list = arrayListOf<ExerciseBreathingDayData>()

    private val dayDetailsBreathingExerciseAdapter by lazy {
        DayDetailsBreathingExerciseNewAdapter(requireActivity() as BaseActivity, list,
            object : DayDetailsBreathingExerciseNewAdapter.AdapterListener {
    ...
    ): ExerciseFragmentDayDetailsBreathingExerciseCommonNewBinding {
        return ExerciseFragmentDayDetailsBreathingExerciseCommonNewBinding.inflate(inflater,
            container,
            attachToRoot)
    }
    ...
    fun setData(list: ArrayList<ExerciseBreathingDayData>, planType: String) {
        if (isAdded) {
            dayDetailsBreathingExerciseAdapter.planType = planType
            this.list.clear()
    ...
    private fun updateBookmarks() {
        ...
        engageContentViewModel.updateBookmarks(apiRequest, analytics, contentData?.content_type,
            screenName = ExercisePlanDayDetail)
    }
