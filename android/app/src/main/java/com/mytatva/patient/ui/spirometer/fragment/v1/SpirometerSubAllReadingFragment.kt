...
class SpirometerSubAllReadingFragment : BaseFragment<SpirometerFragmentSubAllReadingsBinding>() {
    ...
    private fun setUpRecyclerView() {
        ...
        binding.recyclerViewAllReadings.addOnScrollListener(object : PaginationScrollListener(linearLayoutManager!!) {
    ...
    private fun onTestListResponse(spirometerTestResDataArrayList: java.util.ArrayList<SpirometerTestResData>?, msg: String = "") {
        if (isAdded) {
