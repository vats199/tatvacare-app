...
import com.mytatva.patient.databinding.HomeRowStayInformedBinding
...
class HomeStayInformedAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            tvDate.text = DateTimeFormatter.formatDate(item.publish_date.toString(), FORMAT_yyyyMMdd_HHmmss)
        }
    }
