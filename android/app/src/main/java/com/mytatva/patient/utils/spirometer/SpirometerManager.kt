    ...
    fun initStartTestFlow(activity: AppCompatActivity, finishCallback: () -> Unit) {
        ...
        locationManager.startLocationUpdates({ location, exception ->
            ...
            location?.let {
                ...
                StartSpirometryTest.setLatLon(it.latitude.toString(), it.longitude.toString(), activity)
                    ...
                    .setCallback { isIncentive ->
                        ...
                        analytics.logEvent(
                            ...
                            Bundle().apply {
                                ...
                                putString(analytics.PARAM_TEST_TYPE, if(isIncentive) "Incentive" else "Standard")
                            },
