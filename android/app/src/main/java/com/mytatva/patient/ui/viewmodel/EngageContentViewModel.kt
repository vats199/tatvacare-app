...
class EngageContentViewModel @Inject constructor(
    ...
    fun updateBookmarks(
        ...
        if (apiRequest.is_active == "Y") {
            analytics?.logEvent(analytics.USER_BOOKMARKED_CONTENT,
                Bundle().apply {
    ...
    fun updateBookmarksQuestion(
        ...
        if (apiRequest.is_active == "Y") {
            analytics?.logEvent(analytics.USER_BOOKMARKED_QUESTION,
                Bundle().apply {
                    putString(analytics.PARAM_CONTENT_MASTER_ID,
                        apiRequest.content_master_id)
                }, screenName = screenName)
        } else {
            analytics?.logEvent(analytics.USER_UN_BOOKMARK_QUESTION,
                Bundle().apply {
                    putString(analytics.PARAM_CONTENT_MASTER_ID,
                        apiRequest.content_master_id)
                }, screenName = screenName)
    ...
    fun updateLikes(
        ...
        if (apiRequest.is_active == "Y") {
            analytics.logEvent(analytics.USER_LIKED_CONTENT,
                Bundle().apply {
                    putString(analytics.PARAM_CONTENT_MASTER_ID,
                        apiRequest.content_master_id)
                    contentType?.let {
            ...
            analytics.logEvent(analytics.USER_UNLIKED_CONTENT,
                Bundle().apply {
                    putString(analytics.PARAM_CONTENT_MASTER_ID,
                        apiRequest.content_master_id)
                    contentType?.let {
