...
class SegmentedProgressBar(context: Context?, attributeSet: AttributeSet? = null) :
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val circleCenterX = ((actualBarWidth * indicatorPoint)+horizontalSpacing) //(width / 2).toFloat()
    ...
    fun setContexts(barContexts: List<BarContext>, indicatorPoint:Float, indicatorPointColor:Int) {
