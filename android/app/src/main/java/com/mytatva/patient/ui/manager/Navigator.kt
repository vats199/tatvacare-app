...
interface Navigator {
    ...
    fun showAlertDialogWithOptions(message: String, positiveText: String = "Yes", negativeText: String = "No", dialogYesNoListener: BaseActivity.DialogYesNoListener? = null)

    fun showImageViewerDialog(imageLis: ArrayList<String>, position: Int=0)

    fun openPdfViewer(certificate:String)
}