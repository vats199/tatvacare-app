    ...
    private fun setData() = with(binding) {
        when (myDevicesData?.key) {
            Device.BcaScale.deviceKey -> {
                textViewDoYouHaveDevice.text = getString(R.string.connect_smart_scale_label_do_you_have_device)
            }

            Device.Spirometer.deviceKey -> {
                textViewDoYouHaveDevice.text = getString(R.string.connect_label_do_you_have_spirometer_device)
            }
