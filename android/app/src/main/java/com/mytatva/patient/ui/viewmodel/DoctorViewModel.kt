...
class DoctorViewModel @Inject constructor(
     ...
     * @API :- addToCart
     */
    val addToCartLiveData = APILiveData<AddToCartData>()
     ...
     */
    val getAppointmentSlotsLiveData = APILiveData<ArrayList<LabTestTimeSlotData>>()
     ...
     * @API :- cancelLabTest
     */
    val cancelLabTestLiveData = APILiveData<Any>()
    fun cancelLabTest(apiRequest: ApiRequest) {
        viewModelScope.launch {
            val result = doctorRepository.cancelLabTest(apiRequest)
            cancelLabTestLiveData.value = result
        }
    }
     ...
     * @API :- catalogList
     */
    val catalogListLiveData = APILiveData<ArrayList<CatalogListData>>()
    fun catalogList(apiRequest: ApiRequest) {
        viewModelScope.launch {
            val result = doctorRepository.catalogList(apiRequest)
            catalogListLiveData.value = result
        }
    }
     ...
     * @API :- catalogListAll
     */
    val catalogListAllLiveData = APILiveData<ArrayList<TestPackageData>>()
    fun catalogListAll(apiRequest: ApiRequest) {
        viewModelScope.launch {
            val result = doctorRepository.catalogListAll(apiRequest)
            catalogListAllLiveData.value = result
        }
    }

    /**
     * @API :- searchCatalogListAll
     */
    val searchCatalogListAllLiveData = APILiveData<ArrayList<TestPackageData>>()
    fun searchCatalogList(apiRequest: ApiRequest) {
        viewModelScope.launch {
            val result = doctorRepository.searchCatalogList(apiRequest)
            searchCatalogListAllLiveData.value = result
        }
    }
     ...
     * @API :- catalogDetails
     */
    val catalogDetailsLiveData = APILiveData<TestPackageData>()
    fun catalogDetails(apiRequest: ApiRequest) {
        viewModelScope.launch {
            val result = doctorRepository.catalogDetails(apiRequest)
            catalogDetailsLiveData.value = result
        }
    }
     ...
     */
    val confirmationOrderLiveData = APILiveData<ConfirmationPaymentData>()
    fun confirmationOrder(apiRequest: ApiRequest) {
        viewModelScope.launch {
            val result = doctorRepository.confirmationOrder(apiRequest)
            confirmationOrderLiveData.value = result
        }
    }

    /**
     * @API :- rescheduleLabTest
     */
    val rescheduleLabTestLiveData = APILiveData<Any>()
    fun rescheduleLabTest(apiRequest: ApiRequest) {
        viewModelScope.launch {
            val result = doctorRepository.rescheduleLabTest(apiRequest)
            rescheduleLabTestLiveData.value = result
        }
    }

    /**
     * @API :- getNearByExpireBCPData
     */
    val getNearByExpireBCPDataLiveData = APILiveData<BcpTestMainData>()
    fun getNearByExpireBCPData(apiRequest: ApiRequest) {
        viewModelScope.launch {
            val result = doctorRepository.getNearByExpireBCPData(apiRequest)
            getNearByExpireBCPDataLiveData.value = result
        }
    }
}