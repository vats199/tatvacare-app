...
class ApiRequest {
    ...
    var catalog_category_master_id: String? = null
    ...
    var vendor_flag: String? = null

    @SerializedName("collection_slot_id")
    var collection_slot_id: String? = null

    @SerializedName("is_recent_added")
    var is_recent_added: String? = null
    ...
    var force_add: String? = null

    @SerializedName("conflicting_codes_to_remove")
    var conflicting_codes_to_remove: String? = null
}