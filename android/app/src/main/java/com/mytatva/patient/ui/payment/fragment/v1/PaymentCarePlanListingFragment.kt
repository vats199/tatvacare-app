...
class PaymentCarePlanListingFragment : BaseFragment<PaymentFragmentCareplanListingBinding>() {
    ...
    //show_plan_type -> (show_nutritionist,show_physio,show_book_device)
    private val showPlanType: String? by lazy {
        arguments?.getString(Common.BundleKey.SHOW_PLAN_TYPE)
    }
