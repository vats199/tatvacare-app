...
import com.mytatva.patient.data.pojo.response.ExerciseTopicsData
import com.mytatva.patient.databinding.EngageRowFilterItemCommonBinding

class FilterExerciseGenresAdapter(var list: List<ExerciseFilterCommonData>) :
    RecyclerView.Adapter<FilterExerciseGenresAdapter.ViewHolder>() {
