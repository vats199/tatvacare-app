...
class FullScreenImageAdapter(
    private val _activity: Context,
    private val _imagePaths: List<String>,
    private val onOutSideClick: OnOutSideClick?
) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val viewLayout =
            inflater.inflate(R.layout.common_row_full_screen_imageview, container, false)
