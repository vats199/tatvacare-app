...
class CommonWheelPickerDialog : BaseBottomSheetDialogFragment<SpirometerBottomsheetDetailsTypeBinding>() {
    ...
    companion object {
        fun showBottomSheet(
            ...
            callback: (Int) -> Unit
        ): CommonWheelPickerDialog
            = CommonWheelPickerDialog().apply {
                this.title = title
