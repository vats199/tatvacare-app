...
/*(val activity: Activity)*/ {
    ...
    fun getFileNameForBcaReport(): String {
        ...
        //?.replace("'","")
        //?.replace(".","")
        return "${fName}'s Smart Analyser Report - ".plus(
            SimpleDateFormat(
                "dd-MM-yyyy HH-mm",
                Locale.US
            ).format(Date())
    ...
    fun getFileNameForSpirometerReport(): String {
        ...
        //?.replace("'","")
        //?.replace(".","")
        return "${fName}'s Spirometer Report - ".plus(
            SimpleDateFormat(
                "dd-MM-yyyy HH-mm",
                Locale.US
            ).format(Date())
    ...
    fun getFileNameForInvoice(): String {
        val fName = session.user?.name
        return "Invoice - ".plus(SimpleDateFormat("dd-MM-yyyy HH-mm", Locale.US).format(Date()))
            .plus(".pdf")
    }
