...
interface DoctorRepository {
    ...
    suspend fun getAppointmentSlots(apiRequest: ApiRequest): DataWrapper<ArrayList<LabTestTimeSlotData>>
    ...
    suspend fun cancelLabTest(apiRequest: ApiRequest): DataWrapper<Any>
    ...
    suspend fun catalogList(apiRequest: ApiRequest): DataWrapper<ArrayList<CatalogListData>>
    suspend fun searchCatalogList(apiRequest: ApiRequest): DataWrapper<ArrayList<TestPackageData>>
    suspend fun catalogListAll(apiRequest: ApiRequest): DataWrapper<ArrayList<TestPackageData>>
    suspend fun catalogDetails(apiRequest: ApiRequest): DataWrapper<TestPackageData>
    suspend fun confirmationOrder(apiRequest: ApiRequest): DataWrapper<ConfirmationPaymentData>
    suspend fun rescheduleLabTest(apiRequest: ApiRequest): DataWrapper<Any>
    suspend fun getNearByExpireBCPData(apiRequest: ApiRequest): DataWrapper<BcpTestMainData>
}