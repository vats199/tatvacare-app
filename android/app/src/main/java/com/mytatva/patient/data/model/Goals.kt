...
enum class Goals constructor(val goalKey: String, val maxGoalValue: Int) {
    Medication("medication", -1),// no max required
    Exercise("exercise", 600),
    Pranayam("pranayam", 600),
    Steps("steps", 100000),
    WaterIntake("water", 100),
    Sleep("sleep", 24),
    Diet("diet", 5000)
}
