...
class DeviceInfoConnectBottomSheetDialog :
    BaseBottomSheetDialogFragment<MydeviceBottomsheetDeviceInfoConnectBinding>() {
    ...
    override fun createViewBinding(
        ...
        return MydeviceBottomsheetDeviceInfoConnectBinding.inflate(
            inflater,
            container,
            attachToRoot
        )
