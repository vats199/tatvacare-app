...
enum class DrawerItem constructor(val drawerItem: String, val colorRes: Int, val icon: Int) {
    ...
    TransactionHistory(
        ...
        R.drawable.ic_menu_payment_history
    ),

    DefineYourGoals("Define Your Goals", R.color.colorPrimary, R.drawable.ic_menu_deine_goals),
    GoalsAndHealthTrends(
        "Goals and Health Trends",
        R.color.colorPrimary,
        R.drawable.ic_menu_goals_health_trends
    ),

    DiagnosticReports(
        "Diagnostic Report(s)",
        R.color.colorPrimary,
        R.drawable.ic_menu_diagnostic_reports_new
    ),
