...
public final class HorizontalCalendar {
    ...
    public void setRange(Calendar startDate, Calendar endDate) {
        ...
        mCalendarAdapter.update(startDate, endDate, true);
    }
    ...
    public void setDataCount(ArrayList<String> selectDateCount) {

        if (mCalendarAdapter instanceof DaysAdapter) {
            ((DaysAdapter) mCalendarAdapter).dataLists = selectDateCount;
            mCalendarAdapter.notifyDataSetChanged();
        }
    }
